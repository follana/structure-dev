...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230103_sitedevoyage_final_sandy_76a0f554dd2f794b8101_20230104142906_archive.zip';
        const ARCHIVE_SIZE       = '80036350';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '76a0f55-04142906';
        const SECONDARY_PACKAGE_HASH = '5e6ecd9-04142906';
        const VERSION            = '1.5.1';
